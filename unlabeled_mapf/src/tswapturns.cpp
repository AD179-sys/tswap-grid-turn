#include "../include/tswapturns.hpp"

#include <alloca.h>

#include <fstream>

const std::string TSWAPTurns::SOLVER_NAME = "TSWAPTurns";

TSWAPTurns::TSWAPTurns(Problem* _P)
    : Solver(_P),
...
Node* TSWAPTurns::getNextNode(Node* a, Node* b)
{
...
void TSWAPTurns::printHelp()
{
  std::cout
      << TSWAPTurns::SOLVER_NAME << "\n"
...
void TSWAPTurns::makeLog(const std::string& logfile)
{
  std::ofstream log;
